...
nba_main %>%
  ...
  #pivot_longer(cols = 2:7, names_to = "variable", values_to = "value") # does the same thing, but is the "tidyverse" way of doing things
...
ui <- fluidPage(titlePanel("2019 NBA Performance"),
                mainPanel(
                  width = 12,
                  splitLayout(
                    cellWidths = c("50%", "50%"),
